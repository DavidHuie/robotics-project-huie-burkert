...
BLACK_LOWER = cv.CV_RGB(values[0][0],values[1][0],values[2][0])
BLACK_UPPER = cv.CV_RGB(values[0][1],values[1][1],values[2][1])
...
while True:
	...
	yellowPixels = mark_pixels(mat, TEST_LOW, TEST_UP)
